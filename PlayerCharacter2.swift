...
class PlayerCharacter2 : SkinnedCharacter, GameObject {
    ...
    init(characterNode:SCNNode)
    {
        ...
        self.changeState(PlayerState.Walking)
    ...
    func addCollideSphere() {
        ...
        collideSphere.name = "PlayerCollideSphere2";
        ...
        print("player box x:\(collideSphere.position.x) y:\(collideSphere.position.y) z:\(collideSphere.position.z)")
    ...
    func handleContact(node:SCNNode) {
        ...
        if(node.name == "FrontWall") {
            ...
            print("Player collided with node: \(node.name)");
    ...
    func update(deltaTime:NSTimeInterval) {
        ...
        //
        //            //print("velocity x is \(joystick?.velocity.x) and \(joystick?.velocity.y)")
        //
